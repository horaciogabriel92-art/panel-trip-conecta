  ...
  if (!vendedor) {
    return (
      <div className="text-center py-20">
        <h2 className="text-2xl font-bold text-white">Vendedor no encontrado</h2>
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex items-center gap-4">
        <Link href="/admin/vendedores" className="p-2 bg-white/5 rounded-xl hover:bg-white/10 transition-all">
          <ArrowLeft className="w-5 h-5 text-slate-400" />
        </Link>
        <div className="flex-1">
          <h2 className="text-2xl font-black text-white">Detalle del Vendedor</h2>
      ...
      <div className="glass-card rounded-2xl p-6">
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 text-sm">ID: {vendedor.id.slice(0, 12)}...</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-white">{vendedor.email}</p>
              </div>
            </div>
            {vendedor.telefono && (
              <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">{vendedor.telefono}</p>
                </div>
              </div>
            )}
            <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-white font-medium text-purple-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="glass-card p-6 rounded-2xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-slate-400">Total Cotizaciones</p>
          </div>
          <p className="text-3xl font-black text-white">{stats.totalCotizaciones}</p>
        </div>
        <div className="glass-card p-6 rounded-2xl">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="glass-card p-6 rounded-2xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-slate-400">Comisión Total</p>
          </div>
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        ...
        {cotizaciones.length === 0 ? (
          <div className="py-16 text-center">
            ...
            <p className="text-slate-400 text-lg">No hay cotizaciones registradas</p>
                  ...
                  <tr key={c.id} className="border-b border-white/5 hover:bg-white/5 transition-all">
                    ...
                    <td className="p-4">
                      <Link 
                        ...
                        className="p-2 bg-white/5 rounded-lg hover:bg-blue-600 transition-all inline-flex items-center gap-2 text-sm text-slate-300 hover:text-white"
                      >
