              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                    vendedorSeleccionado === v.id ? 'bg-blue-500' : 'bg-white/10'
                  }`}>
...
RP/DZOUY2100/
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-black text-white mb-2">Nueva Cotización (Admin)</h1>
        <p className="text-slate-400">Crea una cotización y asígnala a un vendedor</p>
      </div>
