      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {[1, 2, 3].map((doc) => (
          <div key={doc} className="glass-card p-6 rounded-[2rem] space-y-4 group">
             <div className="h-40 bg-[var(--muted)] rounded-2xl flex items-center justify-center border border-dashed border-[var(--border)] group-hover:border-blue-500/30 transition-all">
                <Files className="w-12 h-12 text-[var(--muted-foreground)] group-hover:text-blue-400 transition-colors" />
             </div>
