...
// Import dinámico del LanguageSwitcher para evitar SSR
      ...
      <div className="flex items-center gap-2 md:gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          <div className="text-right hidden sm:block min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)] uppercase tracking-wider font-bold truncate">{t(`auth.roles.${userRole === 'admin' ? 'admin' : 'vendedor'}`)}</p>
          </div>
