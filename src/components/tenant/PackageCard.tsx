...
export default function PackageCard({
  ...
  return (
    <article
      className="group bg-white rounded-2xl border border-black/10 overflow-hidden flex flex-col h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <div
          className="absolute top-3 left-3 px-2.5 py-1 bg-white/95 rounded-full text-[10px] font-bold uppercase tracking-wide"
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex items-end justify-between pt-4 border-t border-black/10">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 text-sm font-semibold px-4 py-2 rounded-full text-white transition-opacity hover:opacity-90"
